# pocket_commander/agents/tool_agent/__init__.py
from .tool_agent_agent_logic import create_tool_agent_agent_logic
...
# app_core.py will dynamically import and use create_tool_agent_agent_logic.